Programs to build the analysis files from raw input data used to generate empirical results in ``Economic Analysis and Statistical Disclosure Limitation'' by Abowd and Schmutte (2015) 
